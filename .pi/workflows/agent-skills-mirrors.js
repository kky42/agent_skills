...
const finalizerIdentityMatches = finalizerOutcomeValid && finalizer.data.candidate_worktree === current.data.candidate_worktree && finalizer.data.base_commit === current.data.base_commit && finalizer.data.candidate_commit === current.data.candidate_commit;
